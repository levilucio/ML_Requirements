...
classification methods\levi{only classification?}.\\
...
trained to generate\levi{a classifier cannot \emph{generate}} trace links for
...
classify target documents into specific types\levi{didn't get this or
the relation with traceability}.\newline
...
features 4) derive set of classification cases\levi{what does this mean?} 5)
...
learning\levi{so there is some reinforcement learning going on in
traceability. This should also be mentioned at the top of the section\ldots}.
