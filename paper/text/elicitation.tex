...
to decide evolutionary requirements. \levi{bring to common section: The dataset
used POS tagger and parser with additional defined rules for feature extraction.}\\
...
Herrera \etal \cite{Castro-Herrera:2009} provide semi-automatically\levi{provide
what?} manage broad stakeholder participation in the requirements elicitation
...
i.e. themes identification, and assign it to stakeholders accordingly.\levi{?}
...
of these themes for recommender system.\levi{?} Stakeholders needs
