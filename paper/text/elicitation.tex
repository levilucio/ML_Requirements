...
evolution development. Many users share their opinions about various software on Twitter. The huge amount of dataset makes it hard to manually identify tweets that have user requirements. The proposed methodology classify tweets as improvement requests or not, using \emph{Naive Bayes} algorithm. This was the first study of
...
requests and summarize them accordingly. The summarization process contains highly ranked tweets based on parameters including likes, sentiments, and number of shares etc.\\

Williams \etal \cite{Williams:2017} performed a similar study on tweets in order
to classify them as user requirements or not. It used basic pre-processing techniques and applied VSM on data. For the learning
...
algorithm was used?}. The authors claimed with the help of experiment results that
