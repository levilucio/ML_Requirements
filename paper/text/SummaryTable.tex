...
\begin{center}
	\begin{tabular}{|c|l|l|l|l|l|}
		...
		\multirow{3}{*}{\rotatebox[origin=c]{90}{\textbf{S}}} 
			...
			\cdashline{2-6}[.4pt/1pt]
			& Functional \& \\& Non-Functional & \cite{Lu:2017}($\circ$) \cite{Deocadez:2017}($\circ$) \cite {Kurtanovic:2017}($\circ$) \\ && \cite{Abad:2017}($\circ$) \cite {Garzoli:2013}($\circ$) ~\cite{Wieloch:2013}($\circ$)  & Classification  &  Bagging, Naive Bayes, SVM & Open Source PROMISE Dataset \\ &&&&& app-store reviews \\
			\cdashline{2-6}[.4pt/1pt]
