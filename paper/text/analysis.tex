...
identifying \NFR in large and complex documents \cite{Cleland-Huang2007}}This
...
role  label  for  each  word  in  the  sentence) and machine learning and has four steps: corpus construction, NLP
 ...
 dependency parsing.}}
	...
	Wang \etal~\cite{7949577} applied a combination of \ML, natural
language processing, and semantic analysis to automatically extract functional
...
role  label  for  each  word  in  the  sentence) and
 \ML has four steps: corpus construction, NLP
 preprocessing, feature extraction and EFRF (Extended Functional Requirements
 ...
 software requirement specifications. EFRF consists of the 10 \FR types mentioned
...
\NFR into four categories including reliability, usability, portability, and
performance. The approach used a supervised algorithm
...
Bagging was more suitable for \NFR classification in the proposed study than Naïve Bayes and J48\levi{is this
...
software requirement documents written in natural language \levi{which kind?} and classify them into \FR,
\NFR and subcategories of \NFR. The basic pre-processing steps were applied on requirements before applying the ML algorithm. It used supervised \SVM algorithm for classification. Some \NFR were ignored because of their minor presence in the documents. Also, the dataset was imbalanced that meant it was not equally distributed. For avoiding data imbalance problem additional dataset i.e. user comments\levi{what is this?}
