...
Constraint \levi{the class names are not informative}. Their framework has four
steps:
...
automaker systems \levi{which kind of semantic information?}.
...
neural network model to process text for finding the word embedding.\\\\
Deoxadez \etal~\cite{Deocadez:2017}performed semi-supervised classification
techniques for automated classification of FRs and NFRs in user reviews from the app store.
...
stage involved removing numbers, 2- letter words and other symbolic
characters.\\\\
Kutranvoic \etal ~ \cite {Kurtanovic:2017}performed automated
analysis on software requirements and performed classification on FRs, NFRs and
