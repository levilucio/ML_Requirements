...
requirements in which SVM is only applied in a small part of it.
	...
	\tahira{Software requirements are mostly stated in natural text notations such as user
stories which is making it hard for people to develop an accurate mental image
of the most relevant entities and relationships.}
Lucassen \etal~\cite{Lucassen:2016} introduced an automated method for
...
general context for understanding the dataset. It used Word2Vec and Ward’s clustering algorithm to build up inter cluster relationship matrix of concepts from the dataset.\parisa{suggestions for which part to remove for summarizing it?!} 
\tahira{\begin{itemize}
...
specification as “requirement” or “information”.\parisa{requirements elicitation
or management?} Their approach increases the quality of requirements
...
Based on Rauf \etal~\cite{Rauf:2011} software specification documents usually
