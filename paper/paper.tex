...
\newcommand{\NFR}{\textsc{Nfr}\xspace}
\newcommand{\FRs}{\textsc{Fr}s\xspace}
\newcommand{\NFRs}{\textsc{Nfr}s\xspace}
\newcommand{\BR}{\textsc{Br}\xspace}
\newcommand{\UR}{\textsc{Ur}\xspace}
\newcommand{\POS}{\textsc{Pos}\xspace}
\newcommand{\BOW}{\textsc{BoW}\xspace}
\newcommand{\VSM}{\textsc{Vsm}\xspace}
\newcommand{\SVM}{\textsc{Svm}\xspace}
\newcommand{\DT}{\textsc{Dt}\xspace}
\newcommand{\FRs}{\textsc{Fr}\xspace}
\newcommand{\BNB}{\textsc{Bnb}\xspace}

\newcommand{\fig}{\text{figure}\xspace}
\newcommand{\sect}{\text{section}\xspace} 
\newcommand{\tab}{\text{table}\xspace}
\newcommand{\Tab}{\text{Table}\xspace}  
...
\and
\IEEEauthorblockN{3\textsuperscript{rd} Levi L\'ucio}
\IEEEauthorblockA{\textit{fortiss GmbH} \\ 
Munich, Germany \\
lucio@fortiss.org}}   
\maketitle
